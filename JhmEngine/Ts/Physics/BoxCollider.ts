class BoxCollider implements ICollider, IDestroyable, IComponent {
    ...
    getFirstCollisionPointWithRay(x0: number, y0: number, xDir: number, yDir: number): { x: number; y: number; normalX: number; normalY: number; } {
        throw new Error("Method not implemented.");
    }
    getCollisionPointsWithRay(x0: number, y0: number, lean: number, length: number): { x: number; y: number; normalX: number; normalY: number; }[] {
        throw new Error("Method not implemented.");
    }
